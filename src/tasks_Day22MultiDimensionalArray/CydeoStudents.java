...
public class CydeoStudents {
    public static void main(String[] args) {
        ...
        batch25Group1=Arrays.copyOf(batch25Group1,3);
        batch25Group2=Arrays.copyOf(batch25Group2,3);
        batch25Group3=Arrays.copyOf(batch25Group3,3);
        ...
        batch24Group1=Arrays.copyOf(batch24Group1, 3);
        batch24Group2=Arrays.copyOf(batch24Group2, 3);
        batch24Group3=Arrays.copyOf(batch24Group3, 3);
...
3. CydeoStudents Task:
		...
		2. declare an array variable named batch25Groups with the length of three
				2.1 Assign batch25Group1, batch25Group2, batch25Group1=3 tdo each indexes of the variable batch25Groups
